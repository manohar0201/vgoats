...
| 27 | Substitute picker matches breed + promised weight + delivery eligibility; does not re-check feed clearance on substitute | medium | Assumption that ops picks from clean pool; documented limit | Substitute goat had feed exposure | yes | 2026-05-27 |
| 28 | Feed exposure flags promised bookings but does not auto-block unbooked goats from inventory | medium | Feed trace deferred as sale gate; discrepancy-only for now | Unbooked exposed goat still listable | yes | 2026-05-27 |
